const pack_array = [{
		name: "Better Wandering Trader", updated: 20221210, search_keys: "Villager Trading", description: "With this Data Pack you get a lot of small useful things, which you can trade with Wandering Traders.",
		...
		name: "Dark Theme", updated: 20210615, search_keys: "Inventory Gray Blue", description: "Change the look of the Inventory to a simplistic dark gray and blue colored one.",
		...
		name: "Fried Eggs", updated: 20200728, search_keys: "Food Chicken", description: "With this Data Pack you can cook Eggs in the Furnace, Smoker or on the Campfire to get Fried Eggs.",
		...
		name: "Gateway", updated: 20210708, search_keys: "Travel Portal Teleport TP", description: "Travel between your visited places with just a step. Mark each Gateway with a block to easily remember where it leads.",
		...
		name: "Invisible Item Frame", updated: 20210608, search_keys: "Decoration", description: "Adds a recipe to craft an Invisible Item Frame to make some nice looking buildings.",
		...
		name: "Jump and Run", updated: 20191106, search_keys: "Mini Games Play", description: "Build your personal Jump and Run with checkpoints, timer and more.",
		...
		name: "Powered Enchanting", updated: 20221217, search_keys: "Enchantments Tools Armor Weapons", description: "Enchant your tools and armor with new Enchantments and create your own.",
		pack_id: "powered_enchanting", last_version_id: false, pack_version_id: [128], pack_type: "datapacks", db_id: "320699416718606924"
	},{
		name: "Recipe Unlocker", updated: 20210709, search_keys: "Crafting", description: "A Recipe Unlocker Data Pack which is compatible with NBT-Crafting recipes.",
		...
		name: "Redstone Dot", updated: 20200430, search_keys: "", description: "Get the old look of a single Redstone, without the need of a Resource Pack.",
		pack_id: "redstone_dot", code_version: "1", last_version_id: 127, pack_version_id: [122], pack_type: "datapacks", db_id: "306823532283691531"
	},{
		name: "Short Commands", updated: 20200728, search_keys: "Creative Admin OP", description: "This Data Pack adds new commands to execute existing commands faster.",
		...
		name: "Useful Golden Tools", updated: 20210627, search_keys: "Armor Weapons Enchantments", description: "With this Data Pack all Golden Tools will get a special effect or ability.",
		...
		name: "Wither Soldier", updated: 20210104, search_keys: "Nether Mob Monster Boss", description: "This Data Pack adds a new mob which spawns rarely in the Soul Sand Valley.",
		pack_id: "wither_soldier", code_version: "2.3", last_version_id: false, pack_version_id: [130, 128, 124, 119], rp_version_id: [124, 119], pack_type: "datapacks", db_id: "306823400923333131"
	}
]
