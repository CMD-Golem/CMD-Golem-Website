var translation_array = [{
		...
		level30:"Ви повинні мати 30 рівень",
		level50:"Ви повинні мати 50 рівень"
}]
...
const article_array = [
    ...
    {id:"2", version_id:[138,128], title:["Auto Smelt", "Schmelzer", "뜨거운 손길", "Derretimento Automático", "Fundición", "Авто переплавка"], description:"Smelts blocks you mine", max_lvl:1, chance:2, comp_items:[6,8], ench:["auto_smelt", "silk_touch"], style:"e_golem advanced_ench", tick:"execute as @a[predicate=powerench:auto_smelt] at @s run function powerench:enchantments/auto_smelt"},
    ...
    {id:"j", version_id:[138,128], title:["Leaping", "Springer", "도약", "Pulando", "Salto", "Стрибки"], description:"Increases jump strenght", max_lvl:3, chance:5, comp_items:[4], ench:["leaping"], style:"e_golem", tick:"execute as @a[predicate=powerench:leaping/give] run function powerench:enchantments/leaping/give\nexecute as @a[tag=powerench_leaping,predicate=powerench:leaping/clear] run function powerench:enchantments/leaping/clear"},
    ...
    {id:"t", version_id:[128], title:["Nutrition", "Ernährer", "포만감", "Nutrição", "Nutrición", "Харчування"], description:"Feeds you automatically", max_lvl:1, chance:5, comp_items:[2], ench:["nutrition"], style:"e_golem advanced_ench", tick:"execute as @a[predicate=powerench:nutrition] run effect give @s saturation 1 1 true"},
    ...
    {id:"C", version_id:[128], title:["Reaping", "Ernter", "농부의 손길", "Colhendo", "Cosechador", "Жнива"], description:"Replants seeds automatically", max_lvl:1, chance:5, comp_items:[9], ench:["reaping"], style:"e_golem", tick:"execute as @a[predicate=powerench:reaping] at @s run function powerench:enchantments/reaping"},
    ...
    {id:"U", version_id:[138,128], title:["Vision", "Klarsicht", "시력", "Visão", "Visión", "Бачення"], description:"Gives the player night vision", max_lvl:1, chance:5, comp_items:[1], ench:["vision"], style:"e_golem", tick:"execute as @a[predicate=powerench:vision/give] run function powerench:enchantments/vision/give\nexecute as @a[tag=powerench_vision,predicate=powerench:vision/clear] run function powerench:enchantments/vision/clear"},
